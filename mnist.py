...
# Now adjust model and/or modify hyper-parameters and repeat above steps again
...
# Phase I: We develpe the model, by selecting archicture and different parameters
# train and test using cross-validation

model, x_train, y_train, x_test, \
y_test, epochs, batch_size = develop_the_model()
